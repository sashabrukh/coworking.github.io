  ...
  grunt.initConfig({
    ...
    mfpbuild: {
      all: {
        ...
        basePath: 'src/js/',
        dest: 'baseDist/jquery.magnific-popup.js',
        banner: '<%= banner %>'
      }
    },
    jekyll: {
    ...
    copy: {
      main: {
        files: [
          {expand:true, src: ['baseDist/**'], dest: 'website/'}
        ]
      },
      dev: {
        files: [
          {expand:true, src: ['baseDist/**'], dest: '_site/'}
        ]
      }
    },
    ...
    uglify: {
      my_target: {
        files: {
          'dist/jquery.magnific-popup.min.js': ['baseDist/jquery.magnific-popup.js']
        },
    ...
    cssmin: {
      compress: {
        files: {
          "website/site-assets/all.min.css": ["website/site-assets/site.css", "website/baseDist/magnific-popup.css"]
        }
      }
    }
